    ...
    <div className="w-full h-[60px] bg-black flex justify-center items-center">
      <div className=" w-5/6  flex justify-between flex-row items-center">
        <div className="flex">
          ...
          <div className="font-extrabold text-white text-xl ml-2">VietFLix</div>
        </div>
        <div className="items-center">
          <div className="w-[30em] h-[30px] bg-white rounded-2xl flex items-center">
            <div className="flex flex-row items-center ml-2">
              ...
              <div className="text-sm ml-1">Search for ... </div>
            </div>
          </div>
        </div>
